...
import "./MainPageSecond.css";
import MainThreadSuggestion from "./MainThreadSuggestion";

const MainPageSecond = () => {
  return (
    <div className="main_page_second_container">
      <svg
        className="main_page_second_svg"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 1440 320"
      >
        <path
          className="main_page_second_waveform"
      ...
      <div className="main_page_second">
        <MainThreadSuggestion />
      </div>
    </div>
  );
};
