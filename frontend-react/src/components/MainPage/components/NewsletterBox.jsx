  ...
  return (
    <div className="newsletter_container">
      <div className="newsletter">
        <h3 className="newsletter_title">Subscribe to Newsletter</h3>
        <ul className="newsletter_ul">
          <li>Receive regular updates on new book releases straight to your inbox.</li>
          <li>Stay informed about the latest literary news and trends. lovers and get exclusive</li>
          <li>Join our community of book content delivered to your email.</li>
        </ul>
